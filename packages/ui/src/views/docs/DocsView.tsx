  ...
  return (
    ...
    {deletePending ? (
      <ConfirmDialog
        ...
        onConfirm={() => {
          const currentIndex = bundle.core.documents.findIndex((entry) => entry.id === doc.id);
          const nextDoc = bundle.core.documents[currentIndex + 1] ?? bundle.core.documents[currentIndex - 1] ?? null;
