...
- **Calendar** with accessible month navigation controls, month grid, date-based item visibility, day-level scheduled-work creation through the shared work-item dialog, and an agenda for upcoming start/due dates and timezone-aware reminders that stay visible around UTC/local day boundaries
