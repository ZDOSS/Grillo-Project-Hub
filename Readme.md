...
| `packages/ui` | 34 | AppShell, shared button and surface primitives, WorkItemModal attachment/reminder coverage, BoardView, BacklogView, CommandPalette, launcher, docs, settings |
